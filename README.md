...
Private mirror of **Cursor Agent Skills** collected from this machine: global `~/.cursor/skills`, Cursor meta-skills (`~/.cursor/skills-cursor`), project skills under **Pronea** (`.agents/skills` and `.cursor/skills`).
